    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          <img src={Logo} alt="Logo" className="w-11 h-11 transition-transform duration-300 hover:scale-105" />
          <div className="text-xl sm:text-2xl font-bold text-white block">
            Mohit Sharma
          </div>
        </div>
